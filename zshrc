...
export PATH=/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin:/Users/chelsea/.rvm/bin:/usr/bin
export PATH=$PATH:/usr/local/Cellar/postgresql/9.1.2/bin/postgres/
...
alias rdb="bundle exec rake db:migrate db:test:prepare"
